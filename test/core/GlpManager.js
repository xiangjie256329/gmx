...
describe("GlpManager", function () {
  ...
  it("test addLiquidity, removeLiquidity", async () => {
    ...
    const tx0 = await glpManager.connect(user0).addLiquidity(
      ...
      expandDecimals(99999, 18),
      expandDecimals(99999, 18)
    )
    let blockTime = await getBlockTime(provider)
    console.log("user0 glb:",ethers.utils.formatUnits(await glp.balanceOf(user0.address),18));

    await bnbPriceFeed.setLatestAnswer(toChainlinkPrice(100))
    await bnb.mint(user1.address, expandDecimals(10000, 18))
    await bnb.connect(user1).approve(glpManager.address, expandDecimals(10000, 18))
    console.log("start addLiquidity bnb")
  ...
  //   console.log("start addLiquidity1")
  ...
  //   await vault.setManager(glpManager.address, true)
  //   console.log("start addLiquidity2")
  //   await expect(glpManager.connect(user0).addLiquidity(
  //     dai.address,
  //     expandDecimals(100, 18),
  //     expandDecimals(101, 18),
  ...
  //   console.log("start addLiquidity3")
  //   console.log("glb supply1:",await glp.totalSupply());
  //   const tx0 = await glpManager.connect(user0).addLiquidity(
  //     dai.address,
  //     expandDecimals(100, 18),
  ...
  //     expandDecimals(99, 18)
  //   )
  //   console.log("glb supply2:",await glp.totalSupply());
  //   await reportGasUsed(provider, tx0, "addLiquidity gas used")
  //   console.log("glb supply3:",await glp.totalSupply());
  ...
  //   console.log("start addLiquidity4")
  //   await glpManager.connect(user1).addLiquidity(
  //     bnb.address,
  //     expandDecimals(1, 18),
  ...
  //   console.log("bnbPriceFeed:",ethers.utils.formatUnits(await bnbPriceFeed.latestAnswer(),30));
  //   console.log("max:",ethers.utils.formatUnits(await vault.getMaxPrice(dai.address),30));
  //   console.log("min:",ethers.utils.formatUnits(await vault.getMinPrice(dai.address),30));
